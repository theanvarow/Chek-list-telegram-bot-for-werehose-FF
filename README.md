...
**Профессиональный Telegram-бот для автоматизации контроля чистоты, аудита 22 зон склада и фиксации замечаний на складе фулфилмента.**
...
### 5️⃣ Назначение ответственного лица за смену
| 5. Выбор ответственной смены / специалиста |
| :---: |
| <img src="docs/screenshots/05_responsible_shift.png" width="370" alt="5. Responsible Shift"/> |
...
│   └── screenshots/        # Пошаговые скриншоты работы бота
